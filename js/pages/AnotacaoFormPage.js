 ...
 *  - Responsável: sempre o usuário autenticado (não aparece na tela).
 *  - Tipo: sempre "OBRA" (fixo, não aparece como escolha).
 *  - Progresso: novo campo, opcional.
        ...
        <div className="card-body">
          <div className="row g-3">
            ...
            <div className="col-md-6">
              ...
              <input className="form-control" value={statusOperacionalPreview} disabled placeholder="Selecione o Status ADM acima" />
            </div>
            <div className="col-md-6">
