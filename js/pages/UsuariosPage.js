...
/** Normaliza um nome para comparação robusta: maiúsculas, sem acento, sem espaços duplicados */
...
function usuarioPodeGerenciarUsuarios(session) {
  return !!session && normalizarNome(session.usuario?.nome) === normalizarNome(USUARIO_ADMIN_AUTORIZADO);
}
