...
const FIELD_GROUPS = [
  ...
  },
  {
    title: 'Classificação do Serviço', fields: [
      { key: 'SERVIÇO', label: 'Serviço', required: true, type: 'select', options: OBRA_ENUM_OPTIONS['SERVIÇO'] },
      { key: 'AGUA/ESGOTO', label: 'Água / Esgoto', required: true, type: 'select', options: OBRA_ENUM_OPTIONS['AGUA/ESGOTO'] },
      { key: 'PRIORIDADE', label: 'Prioridade', required: true, type: 'select', options: OBRA_ENUM_OPTIONS['PRIORIDADE'] },
      { key: 'UNIDADE_EXECUTANTE', label: 'Unidade Executante', required: true, type: 'select', options: OBRA_ENUM_OPTIONS['UNIDADE_EXECUTANTE'] },
  ...
  {
    title: 'Localização Geográfica (opcional — usada para exibir a obra no mapa)', fields: [
