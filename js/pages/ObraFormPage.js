...
function ObraFormPage({ navigate, params }) {
  ...
  const [form, setForm] = React.useState({ 'LOCAL DA OBRA': '' });
  ...
  const handleGps = async () => {
    ...
    try {
      ...
      handleChange('LOCAL DA OBRA', coords);
    ...
    <div className="fade-in">
      ...
      <form onSubmit={handleSubmit} className="card border-0 shadow-sm">
        <div className="card-body">
          ...
          <h6 className="section-title mt-4">Local da Obra (coordenadas — opcional, usada para exibir a obra no mapa)</h6>
          <div className="row g-3 align-items-end">
            <div className="col-md-6">
              <label className="form-label">Coordenadas (latitude,longitude)</label>
              <input className="form-control" value={form['LOCAL DA OBRA'] || ''} onChange={(e) => handleChange('LOCAL DA OBRA', e.target.value)} placeholder="-23.550520,-46.633308" />
            </div>
            <div className="col-md-4">
