 ...
 * cada filtro NÃO são mais fixas — são calculadas dinamicamente a
 * partir dos valores realmente presentes na base carregada (ver
 * MultiSelectFilter em Common.js), incluindo os 2 campos calculados
 * de status.
 */
const FILTERABLE_OBRA_FIELDS = [
  ...
  { key: 'QUANTIDADE DE BOOSTERS/ELEVATÓRIAS?', label: 'Boosters/Elevatórias' },
  { key: 'INDICADORES RELACIONADOS', label: 'Indicadores Relacionados' },
  { key: 'PRIORIDADE', label: 'Prioridade' },
  { key: 'POLO DE MANUTENÇÃO', label: 'Polo de Manutenção' },
  { key: 'StatusAdmAtual', label: 'Status ADM' },
  { key: 'StatusAtual', label: 'Status Operacional' }
];

/**
 * Os 11 campos do formulário simplificado de Obra (todos "combo com
 ...
 * (não fazem parte da lista de combos).
 */
const OBRA_FORM_FIELDS_SIMPLES = [
  { key: 'LOCAL DA OBRA', label: 'Local da Obra' },
