...
const ObrasAPI = {
  ...
  listCampoDistinto: (campo) => apiGet('listCampoDistintoObra', { campo })
};
...
const UsuariosAPI = {
  list: () => apiGet('listUsuarios'),
  create: (payload) => apiPost('createUsuario', payload),
  update: (payload) => apiPost('updateUsuario', payload),
  listResponsaveis: () => apiGet('listResponsaveis')
};
